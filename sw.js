const CACHE_NAME = 'student-progress-offline-v21-guardian-cloud-trust';
const ROOT = './';
const APP_SHELL = [
  ...
  './scripts/entry-pwa.js?v=guardian-cloud-trust-1', './scripts/dashboard-v5.js?v=guardian-cloud-trust-1', './scripts/backup-wire.js', './scripts/modal-close-fix.js', './scripts/batch-workspace.js?v=batch-production-14', './scripts/locale.js?v=locale-production-3', './scripts/online-firebase.js?v=guardian-cloud-trust-1', './assets/avatars/catalog.js?v=avatar-catalog-3',
  './student-workspace/index.html', './student-workspace/manifest.json', './student-workspace/brand-logo.png', './student-workspace/icon.svg', './student-workspace/workspace-i18n.js', './student-workspace/assets/index-DPdNrLsu.js', './student-workspace/assets/index-D_Dn3Xft.css'
].concat(
