const CACHE_NAME = 'student-progress-offline-v20-guardian-cloud-repair';
const ROOT = './';
const APP_SHELL = [
  ...
  './scripts/entry-pwa.js?v=guardian-invite-fix-1', './scripts/dashboard-v5.js?v=guardian-cloud-repair-1', './scripts/backup-wire.js', './scripts/modal-close-fix.js', './scripts/batch-workspace.js?v=batch-production-14', './scripts/locale.js?v=locale-production-3', './scripts/online-firebase.js?v=guardian-cloud-repair-1', './assets/avatars/catalog.js?v=avatar-catalog-3',
