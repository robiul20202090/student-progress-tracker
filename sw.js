const CACHE_NAME = 'student-progress-offline-v24-guardian-recovery-2';
const ROOT = './';
const APP_SHELL = [
  ...
  './scripts/entry-pwa.js?v=guardian-invite-fix-1', './scripts/dashboard-v5.js?v=guardian-recovery-2', './scripts/backup-wire.js', './scripts/modal-close-fix.js', './scripts/batch-workspace.js?v=batch-production-16', './scripts/locale.js?v=locale-production-3', './scripts/online-firebase.js?v=guardian-recovery-2', './assets/avatars/catalog.js?v=avatar-catalog-3',
