const CACHE_NAME = 'student-progress-offline-v22-cloud-dialog-fix';
const ROOT = './';
const APP_SHELL = [
  ...
  './scripts/entry-pwa.js?v=guardian-cloud-trust-1', './scripts/dashboard-v5.js?v=guardian-cloud-trust-1', './scripts/backup-wire.js', './scripts/modal-close-fix.js', './scripts/batch-workspace.js?v=batch-production-14', './scripts/locale.js?v=locale-production-3', './scripts/online-firebase.js?v=guardian-cloud-trust-2', './assets/avatars/catalog.js?v=avatar-catalog-3',
